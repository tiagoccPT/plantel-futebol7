...
void main() {
  test('Supabase permite ler e regravar o mesmo plantel', () async {
    ...
    final getUri = Uri.parse(base).replace(queryParameters: const {
      'plantel_id': 'eq.$id',
    ...
    expect(row['plantel_id'], id);

    final postUri = Uri.parse(base).replace(queryParameters: const {
